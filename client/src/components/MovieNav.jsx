...
import { Navbar, NavbarBrand, Nav, NavItem, Button, Input } from 'reactstrap';
  ...
  render() {
    return (
      <div className="MovieNav">
        <Navbar id="movie-nav" color="light" light expand="md">
          <NavbarBrand className="brand" href="https://fontmeme.com/vimeo-font/">
            <img
              src="https://fontmeme.com/permalink/190306/41c30725258e006cf97cd3c8d478931e.png"
              alt="vimeo-font"
              border="0"
            />
          </NavbarBrand>
